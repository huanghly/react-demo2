export default [
  ...
  // app
  {
    ...
    routes: [
      ...
      { 
        path: '/sourceconfiglist',
        name: 'sourceconfiglist',
        icon: 'dashboard',
        component: './SourceConfig/ListView',
      },
      {
        path: '/sourceconfigadd',
        name: 'sourceconfigadd',
        hideInMenu: true,
        component: './SourceConfig/AddView',
      },
      {
        path: '/sourceconfigedit',
        name: 'sourceconfigedit',
        hideInMenu: true,
        component: './SourceConfig/EditView',
      },
      {
        path: '/labelrelationlist',
        name: 'labelrelationlist',
        icon: 'dashboard',
        component: './LabelRelation/ListView',
      },
      {
        path: '/labelrelationsetting',
        name: 'labelrelationsetting',
        hideInMenu: true,
        component: './LabelRelation/SettingView',
      },
      {
        path: '/labelwareroomlist',
        name: 'labelwareroomlist',
        icon: 'dashboard',
