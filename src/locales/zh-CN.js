export default {
  ...
  'menu.evaluation-center': '评价中心',
  'menu.evaluation-center.evaluation-management': '事项评价管理',
  'menu.evaluation-center.evaluation-details': '事项评价详情',
  'menu.evaluation-center.source-config-list': '来源配置',
  'menu.evaluation-center.source-config-add': '来源配置-新增',
  'menu.evaluation-center.source-config-edit': '来源配置-编辑',
  'menu.evaluation-center.label-relation-list': '标签关联',
  'menu.evaluation-center.label-relation-setting': '标签关联-设置',
  'menu.evaluation-center.label-wareroom-list': '评价标签库',
  'menu.evaluation-center.statistics': '评价统计',
  'menu.system-management': '系统管理',
  'menu.system-management.user-management': '用户管理',
  'menu.system-management.user-edit': '用户编辑',
  'menu.system-management.user-add': '开通用户',
  'menu.system-management.role-management': '角色管理',
  'menu.system-management.permission-management': '权限管理',
  'app.statistics.total-num': '参与评价历史人次',
  'app.statistics.today-num': '今日评价人次',
  'app.statistics.week': '周同比',
  'app.statistics.day': '日环比',
  'app.statistics.total-matter': '接入事项总量',
  'app.statistics.trend-rank': '趋势和排行',
  'app.statistics.trend': '参与评价人次趋势',
  'app.statistics.rank': '事项评价星级排行',
  'app.statistics.tag': '办事评级标签',
  'app.statistics.proportion': '标签选择占比',
